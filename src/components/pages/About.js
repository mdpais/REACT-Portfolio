...
export default function About() {
  return (
    <div className='main'>
      <h2>About Me</h2>
      <div class="card single about mb-3">
        <div class="row g-0">
          <div class="col-md-4">
            <div class="avatar">
          ...
          <div class="col-md-8">
            <div class="card-body">
              <h4 class="card-title">This is Me</h4>
              ...
              <p class="card-text sub"><small class="text-body-secondary">Last updated 28 March 2023</small></p>
            </div>
          </div>
        </div>
      </div>
